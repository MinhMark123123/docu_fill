...
part of 'fields_input_view_model.dart';
...
extension $FieldsInputViewModel on FieldsInputViewModel {
  ...
  StreamData<bool> get enableEditNameDoc => _enableEditNameDoc.streamData;

  /// This getter is used to access the stream of data
  /// associated with the private field _enableExported.
  StreamData<bool> get enableExported => _enableExported.streamData;
